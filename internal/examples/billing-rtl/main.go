...
func main() {
	...
	m.RTL()
	m.AddUTF8Font("Vazir", consts.Normal, "internal/assets/fonts/vazir/Vazir.ttf")
	m.AddUTF8Font("Vazir", consts.Bold, "internal/assets/fonts/vazir/Vazir-Bold.ttf")
	m.SetDefaultFontFamily("Vazir")
	//m.SetBorder(true)

	m.RegisterHeader(func() {
		m.Row(20, func() {
			m.SetBackgroundColor(grayColor)
			m.SetRoundedRect(4, "1234", "DF")
			m.SetBackgroundColor(whiteColor)
			m.Col(3, func() {

				m.Text("اطلاعات مربوط به شرکت", props.Text{
					Size:        8,
					Align:       consts.Right,
					Extrapolate: false,
					Color:       redColor,
				})
				m.Text("شماره تماس: 09903669556", props.Text{
					Top:   12,
					Style: consts.Normal,
					Size:  8,
					Align: consts.Right,
	...
	m.Row(10, func() {
		m.Col(12, func() {
			m.Text("فاکتور ABC123456789", props.Text{
				Top:   3,
				Style: consts.Bold,
				Align: consts.Center,
			})
	...
	err := m.OutputFileAndClose("internal/examples/pdfs/billing-rtl.pdf")
	if err != nil {
