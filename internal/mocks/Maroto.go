...
func (_m *Maroto) AddUTF8FontFromBytes(familyStr string, styleStr consts.Style, utf8Bytes []byte) {
...
// SetRoundedRect provides a mock function with given fields: r, corners, stylestr
func (_m *Maroto) SetRoundedRect(r float64, corners string, stylestr string) {
	_m.Called(r, corners, stylestr)
}
