...
func (_m *Fpdf) AddUTF8FontFromBytes(familyStr string, styleStr string, utf8Bytes []byte) {
...
// AreaX provides a mock function with given fields:
func (_m *Fpdf) AreaX() float64 {
	ret := _m.Called()
...
// IsRTL provides a mock function with given fields:
func (_m *Fpdf) IsRTL() bool {
	ret := _m.Called()
...
// RTL provides a mock function with given fields:
func (_m *Fpdf) RTL() {
	_m.Called()
}
...
// RoundedRect provides a mock function with given fields: x, y, w, h, r, corners, stylestr
func (_m *Fpdf) RoundedRect(x float64, y float64, w float64, h float64, r float64, corners string, stylestr string) {
	_m.Called(x, y, w, h, r, corners, stylestr)
}
